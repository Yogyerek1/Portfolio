...
export default function AboutMe({name, description}: AboutMeProps) {
    return (
        <div className="flex flex-col items-center w-full min-h-screen pt-14 p-5 bg-slate-800">
            <div>
                <img 
                    src={profileImg} 
                    alt="ProfileImg" 
            ...
            <div>
                <h1 className="text-3xl text-center md:text-4xl lg:text-5xl font-bold text-blue-400 drop-shadow-[0_0_15px_rgba(96,165,250,0.8)] hover:drop-shadow-[0_0_30px_rgba(96,165,250,0.85)] transition-all duration-300">
                    {name}
                </h1>
            </div>
            <div className="mt-6">
